...
insert into public.spaces(slug,name,category,summary,description,features,tag,image_url,image_alt,calendly_url,allowance_kind,capacity,hourly_rate,sort_order,staff_addons) values
...
Podcast and voice-over recording','Record · Produce · Mix','assets/images/studio-large.jpg','Santuri production and recording studio','https://calendly.com/studio-santuri/studio-bookings','studio',5,1000,0,true),
...
Private lessons','Practice · Learn · Refine','assets/images/dj-room-large.jpg','Santuri DJ practice room with professional decks','https://calendly.com/djpractice-santuri/30min?primary_color=787878','none',3,1000,1,true),
...
Group rehearsals
Community meetings
Creative collaboration','Teach · Meet · Rehearse','assets/images/classroom-large.webp','Santuri classroom set up for a group session','https://calendly.com/classroompractice-santuri/30min','none',20,1000,2,true),
...
Electronics projects','Work · Learn · Build','assets/images/workstation-large2.jpg','Santuri workstation for focused creative work','https://calendly.com/santuriworkstations-santuri/30min','production',1,1000,3,false)
